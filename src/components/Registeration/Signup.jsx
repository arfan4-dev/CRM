...
const handleSignup = async (e) => {
  ...
  try {
      ...
      // Optionally, you can redirect to a success page or handle the response
  } catch (error) {
    toast.error('Fill all the details or user exist')
...
<p className=' text-4xl text-white font-semibold'>Sign up</p>
...
<button onClick={handleSignup} type='submit' className="inline-flex items-center  mx-7 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
